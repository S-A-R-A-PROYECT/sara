        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-[#114D58] text-white rounded-xl p-4 shadow-lg">
                ...
                <ul class="mt-4 space-y-3 text-sm">
                    ...
                    <li class="flex justify-between"><span>Darlene Robertson</span><span class="font-bold">30%</span>
                    </li>
                    <li class="flex justify-between"><span>Jenny Wilson</span><span class="font-bold">20%</span></li>
                    <li class="flex justify-between"><span>Cameron Williamson</span><span class="font-bold">50%</span>
                    </li>
            ...
            <div class="bg-[#39BFC0] text-white rounded-xl p-6 shadow-lg">
                ...
                <ul class="mt-4 space-y-3 text-sm">
                    ...
                    <li class="flex justify-between"><span>Darlene Robertson</span><span class="font-bold">3/10</span>
                    </li>
                    <li class="flex justify-between"><span>Jenny Wilson</span><span class="font-bold">2/10</span></li>
                    <li class="flex justify-between"><span>Cameron Williamson</span><span class="font-bold">5/10</span>
                    </li>
