...
<div class="bg-gray-100 p-6 min-h-screen">
  <h1 class="text-3xl font-bold mb-6 text-cyan-800">BIENVENIDO RAMIRO SOLER</h1>
 ...
 <!-- Botón excusa -->
  <div class="flex justify-center mt-6">
    <a href="{{ route('home') }}" 
       class="bg-teal-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-teal-600">
        Presentar excusa
    </a>
</div>
