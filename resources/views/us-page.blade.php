...
<div class="bg-white font-sans flex flex-col min-h-screen">
    ...
    <main class="flex-grow flex justify-center px-6 pb-16">
        <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-8 max-w-7xl w-full text-lg md:text-xl items-stretch">
            ...
            <div class="group cursor-pointer h-full flex flex-col">
                ...
                <div
                    class="border-2 border-[#F2AC2A] bg-yellow-50 p-8 rounded-xl
            ...
            <div class="group cursor-pointer h-full flex flex-col">
                ...
                <div
                    class="border-2 border-[#114D58] bg-teal-50 p-8 rounded-xl
                    transition-transform duration-300 ease-out group-hover:-translate-y-4 group-hover:shadow-xl flex-1">
            ...
            <div class="group cursor-pointer h-full flex flex-col">
                ...
                <div
                    class="border-2 border-[#F25041] bg-red-50 p-8 rounded-xl
                    transition-transform duration-300 ease-out group-hover:-translate-y-4 group-hover:shadow-xl flex-1">
            ...
            <div class="group cursor-pointer h-full flex flex-col">
                ...
                <div
                    class="border-2 border-[#39BFC0] bg-cyan-50 p-8 rounded-xl
                    transition-transform duration-300 ease-out group-hover:-translate-y-4 group-hover:shadow-xl flex-1">
                    <p class="text-gray-800 font-medium">
