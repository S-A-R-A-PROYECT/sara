<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <header class="p-6 bg-white shadow-md flex justify-between items-center">
    ...
    <div class="flex gap-3">
      <button class="px-4 py-2 rounded-xl bg-green-600 text-white transition-transform duration-200 hover:bg-green-700 hover:scale-105">Exportar Excel</button>
      <button class="px-4 py-2 rounded-xl bg-red-600 text-white transition-transform duration-200 hover:bg-red-700 hover:scale-105">Descargar PDF</button>
      <button class="px-4 py-2 rounded-xl bg-[#F2AC2A] text-white transition-transform duration-200 hover:bg-yellow-600 hover:scale-105">Actualizar</button>
    </div>
  </header>

  <!-- Filtros -->
  <section class="p-6 flex flex-wrap gap-3 items-center bg-white shadow-sm mt-4 rounded-xl mx-4">
    <input type="text" placeholder="Buscar estudiante..." class="px-4 py-2 border rounded-xl focus:ring-2 focus:ring-[#F2AC2A] w-64 transition duration-200 hover:shadow-md">
    <input type="date" class="px-4 py-2 border rounded-xl focus:ring-2 focus:ring-[#F2AC2A] transition duration-200 hover:shadow-md">
    <input type="date" class="px-4 py-2 border rounded-xl focus:ring-2 focus:ring-[#F2AC2A] transition duration-200 hover:shadow-md">
  </section>
