  ...
  <main class="flex items-center justify-between w-11/12 max-w-7xl">
    ...
    <div class="flex flex-col items-center gap-14">
      ...
      <div class="grid grid-cols-2 gap-10 w-[44rem]">
        <button class="bg-teal-900 text-white text-2xl font-semibold py-6 rounded-xl shadow-lg hover:bg-teal-700 hover:scale-105 hover:shadow-xl transition-all duration-300">
          Acceder al sistema
        </button>
        <button class="bg-teal-900 text-white text-2xl font-semibold py-6 rounded-xl shadow-lg hover:bg-teal-700 hover:scale-105 hover:shadow-xl transition-all duration-300">
    ...
    <div class="w-[32rem]">
      <img src="{{ asset('img/almuerzo.png') }}" alt="Estudiantes recibiendo almuerzo" class="w-full object-contain">
    </div>
  </main>
