...
<div class="bg-gray-100 p-6 min-h-screen">
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
    ...
    <button class="bg-yellow-500 text-white py-3 rounded-lg shadow hover:bg-yellow-600">🔍 Buscar estudiante</button>
    <button class="bg-pink-500 text-white py-3 rounded-lg shadow hover:bg-pink-600">👨‍👩‍👧 Notificar acudientes</button>
  </div>
